...
const reboundSound = new Audio('nohayplata.mp3'); // Sonido de rebote
reboundSound.loop = true; // Configura el sonido para que se reproduzca en bucle
reboundSound.play(); // Inicia la reproducción del sonido al cargar el juego
