...
const ballSize = 120; // Tamaño de la pelota (ajustado para que sea más grande)
...
// Cargar el archivo de audio y configurarlo para que suene en bucle
const backgroundSound = new Audio('nohayplata.mp3'); // Sonido de fondo
backgroundSound.loop = true; // Configurar para que suene en bucle
backgroundSound.volume = 0.5; // Ajusta el volumen si es necesario
backgroundSound.play(); // Reproducir el sonido al iniciar el juego
